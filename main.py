...
def main():
   ...
   try:
      ...
      for i in range(20):
            ...
            if response.function_calls is not None:
               ...
               #adds responses to a list where it will be saved to ai's memory later
               responses = []
               ...
               #converts the function call into a message that can be passed back to the ai
               function_message = types.Content(parts = responses, role = "user")
   ...
   #retrieves function calls from the response and adds them to the messages
